...
public class MatrixUtils {
    ...
    public static void calcTransitionMatrix(Matrix4 mat, ru.geekbrains.math.Rect src, ru.geekbrains.math.Rect dst) {
    ...
    public static void calcTransitionMatrix(Matrix3 mat, ru.geekbrains.math.Rect src, ru.geekbrains.math.Rect dst) {
        float scaleX = dst.getWidth() / src.getWidth();
        float scaleY = dst.getHeight() / src.getHeight();
